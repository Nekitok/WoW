...
ZoneDB.private.areaIdToUiMapId = {
    ...
    [4838] = 162, -- Naxxramas - Construct Quarter (fake ID for Naxxramas)
    [4839] = 163, -- Naxxramas - Arachnid Quarter (fake ID for Naxxramas)
    [4840] = 164, -- Naxxramas - Military Quarter (fake ID for Naxxramas)
...
ZoneDB.private.dungeonLocations = {
    ...
    [1477] = {{8, 69.9, 53.5}},
    [1581] = {{40, 42.5, 71.7}},
    [1583] = {{51, 34.8, 85.3}, {46, 29.4, 38.3}},
    [1584] = {{51, 34.8, 85.3}, {46, 29.4, 38.3}},
    [1585] = {{51, 34.8, 85.3}, {46, 29.4, 38.3}},
    [1977] = {{33, 53.8, 17.5}},
    [2017] = {{139, 27.1, 15.7}, {139, 43.5, 19.4}},
    [2057] = {{28, 69.7, 73.2}},
    [2100] = {{405, 29.1, 62.5}},
    [2159] = {{15, 52.6, 76.8}},
    ...
    [2597] = {{36, 66.6, 51.3},},
    [2677] = {{51, 34.8, 85.3}, {46, 29.4, 38.3}},
    [2717] = {{51, 34.8, 85.3}, {46, 29.4, 38.3}},
    [2917] = {{1637, 40.4, 68.3}},
    [2918] = {{1519, 72.7, 54}},
    [3428] = {{1377, 28.6, 92.3}},
    [3429] = {{1377, 28.6, 92.3}},
...
ZoneDB.private.subZoneToParentZone = {
  ...
  [4838] = 3456, -- Naxxramas - Construct Quarter (fake ID for Naxxramas)
  [4839] = 3456, -- Naxxramas - Arachnid Quarter (fake ID for Naxxramas)
  [4840] = 3456, -- Naxxramas - Military Quarter (fake ID for Naxxramas)
  [4841] = 3456, -- Naxxramas - Plague Quarter (fake ID for Naxxramas)
  [4842] = 3456, -- Naxxramas - Frostwyrm Lair (fake ID for Naxxramas)
